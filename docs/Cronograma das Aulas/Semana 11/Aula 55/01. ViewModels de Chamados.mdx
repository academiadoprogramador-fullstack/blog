...
Teremos mais um cadastro com dependência no Gestão de Equipamentos. O Controle de Chamados deverá ser desenvolvido utilizando os mesmos padrões do Controle de Equipamento.

## ViewModels de Chamado

### `FormularioChamadoViewModel` e `SelecionarEquipamentoViewModel`

```cs title="ChamadoViewModels.cs"
...
### `VisualizarChamadosViewModel` e `DetalhesChamadoViewModel`
